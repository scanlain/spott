  ...
  return (
    <>
        <div className='pb-12 text-center'>
            <h1  className='text-5xl md:text-6xl font-bold'> Discover Events</h1>
            <p className='text-lg text-muted-foreground max-w-3xl mx-auto mt-4'>
                Explore featured events, find what&apo;s happening locally, or browse events across India
            </p>
        </div>
