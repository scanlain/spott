      ...
      <section className="pb-16 relative overflow-hidden">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10"> 
          ...
          <div className="text-center sm:text-left">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 leading-[0.95] tracking-right">
              Discover &<br />
              create amazing
              <br />
            ...
            <p className="text-lg sm:text-xl text-gray-400 mb-12 max-w-lg font-light">
              Whether you&apos;r hosting or attending, Spott makes every event memorable. Join our community today.
            </p>
